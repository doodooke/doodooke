<template>
    <el-row @mouseenter.native='showBorder=true' @mouseleave.native='showBorder=false' class="components" style="z-index:1000;top:100px;position:absolute ;width:375px;">
        ...
        <el-row class="popup-wrap">
            <draggable v-model='componentData' :options="{group:'diy'}" @change='changeComponent' class="layout-components">
                <transition-group tag="ul" style='width:335px;min-height:100px;padding:0' :style="{background:formProps.bgColor}">
